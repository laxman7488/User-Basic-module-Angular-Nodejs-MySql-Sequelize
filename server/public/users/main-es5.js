...
module.exports = "\n<h3>All users: <button class=\"btn btn-primary\" routerLink=\"/create-user\">Add User</button></h3>\n<ul>\n    <li *ngFor=\"let user of users\">\n        {{user.name}} | {{user.email}} | {{user.role}}\n        - <a (click)=\"deleteUser(user.id)\" class=\"text-danger\">Delete</a>\n    </li>\n</ul>"
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function (route, state) {
        var sessionUser = this.authenticationService.sessionUserValue;
        if (sessionUser) {
...
/***/ "./src/app/_helpers/http.service.ts":
/*!******************************************!*\
  !*** ./src/app/_helpers/http.service.ts ***!
  \******************************************/
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.intercept = function (request, next) {
        ...
        var baseUrl = "http://localhost:8084/api/1.0/";
...
/*!***********************************!*\
  !*** ./src/app/_helpers/index.ts ***!
  \***********************************/
/*! exports provided: AuthGuard, ErrorInterceptor, JwtInterceptor, FakeBackendInterceptor, fakeBackendProvider, HttpService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _http_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./http.service */ "./src/app/_helpers/http.service.ts");
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(http) {
        this.http = http;
        this.sessionUserSubject = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](JSON.parse(localStorage.getItem('sessionUser')));
        this.sessionUser = this.sessionUserSubject.asObservable();
    }
    Object.defineProperty(AuthenticationService.prototype, "sessionUserValue", {
        get: function () {
    ...
    AuthenticationService.prototype.login = function (email, password) {
        ...
        return this.http.post("login", { email: email, password: password })
            ...
            if (user.status && user.token) {
                ...
                _this.sessionUserSubject.next(user);
            }
            return user;
        }));
    };
...
/* harmony import */ var _content_app_less__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_content_app_less__WEBPACK_IMPORTED_MODULE_4__);
...
var AppComponent = /** @class */ (function () {
    function AppComponent(router, authenticationService) {
        ...
        this.router = router;
        this.authenticationService = authenticationService;
        this.authenticationService.sessionUser.subscribe(function (x) { return _this.sessionUser = x; });
    }
...
/* harmony import */ var _create_user__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./create-user */ "./src/app/create-user/index.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [
                ...
                _create_user__WEBPACK_IMPORTED_MODULE_10__["CreateComponent"],
            ...
            providers: [
                ...
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HTTP_INTERCEPTORS"], useClass: _helpers__WEBPACK_IMPORTED_MODULE_5__["HttpService"], multi: true },
...
/* harmony import */ var _create_user__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./create-user */ "./src/app/create-user/index.ts");
...
var routes = [
    ...
    { path: 'create-user', component: _create_user__WEBPACK_IMPORTED_MODULE_3__["CreateComponent"] },
...
/***/ "./src/app/create-user/create.component.ts":
/*!*************************************************!*\
  !*** ./src/app/create-user/create.component.ts ***!
  \*************************************************/
...
var CreateComponent = /** @class */ (function () {
    function CreateComponent(formBuilder, router, userService, alertService) {
    ...
    CreateComponent.prototype.onSubmit = function () {
        ...
        this.userService.create(this.createForm.value)
            ...
            if (data.status) {
                _this.alertService.success('User added successful', true);
    ...
    CreateComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({ template: __webpack_require__(/*! raw-loader!./create.component.html */ "./node_modules/raw-loader/index.js!./src/app/create-user/create.component.html") })
    ], CreateComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _create_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./create.component */ "./src/app/create-user/create.component.ts");
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(authenticationService, userService, alertService) {
        var _this = this;
        this.authenticationService = authenticationService;
        this.userService = userService;
        this.alertService = alertService;
        this.users = [];
        this.sessionUserSubscription = this.authenticationService.sessionUser.subscribe(function (user) {
            _this.sessionUser = user;
        });
    }
    ...
    HomeComponent.prototype.loadAllUsers = function () {
        var _this = this;
        this.userService.getAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe(function (data) {
            var allUser = (data.status && data.data) ? data.data : [];
            _this.users = allUser;
        });
    };
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(formBuilder, route, router, authenticationService, alertService) {
        ...
        if (this.authenticationService.sessionUserValue) {
...
module.exports = __webpack_require__(/*! D:\dev\users\client\src\main.ts */"./src/main.ts");
